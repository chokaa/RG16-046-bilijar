...
static void onTimerOstale(int id)
{
    ...
    if ((pozicija_crvena_z >= (pozicija_bela_z + 0.2)) && (pozicija_crvena_z <= (pozicija_bela_z - 0.2)) && (pozicija_crvena_x <= (pozicija_bela_x + 0.2)) && (pozicija_crvena_x >= (pozicija_bela_x - 0.2))) {
        intenzitet_crvena /= 2;
    ...
    if (intenzitet_crvena > 0 && intenzitet_bela > 0) {
        ...
        else if ((pozicija_crvena_x - 0.2) <= 0)
            vektor_x_crvena = vektor_x_crvena * (-1);
        else if ((pozicija_crvena_z + 0.2) >= duzina_stola)
            vektor_z_crvena = vektor_z_crvena * (-1);
        else if ((pozicija_crvena_z - 0.1) <= 0)
            vektor_z_crvena = vektor_z_crvena * (-1);
...
static void onTimerBela(int id)
{
    ...
    if ((pozicija_bela_z <= (pozicija_crvena_z + 0.25)) && (pozicija_bela_z >= (pozicija_crvena_z - 0.25)) && (pozicija_bela_x <= (pozicija_crvena_x + 0.25)) && (pozicija_bela_x >= (pozicija_crvena_x - 0.25))) {
        TIMER_LOPTE *= 1.5;
        intenzitet_bela -= 5;
        intenzitet_crvena /= 2;
