...
static float pozicija_prve_rupe_x = 0.0;
static float pozicija_prve_rupe_z = 0.0;

static float pozicija_druge_rupe_x = 7.0;
static float pozicija_druge_rupe_z = 0.0;


static float pozicija_trece_rupe_x = 0.0;
static float pozicija_trece_rupe_z = 6.0;

static float pozicija_cetvrte_rupe_x = 7.0;
static float pozicija_cetvrte_rupe_z = 6.0;

static float pozicija_pete_rupe_x = 0.0;
static float pozicija_pete_rupe_z = 11.5;

static float pozicija_seste_rupe_x = 7.0;
static float pozicija_seste_rupe_z = 11.5;
